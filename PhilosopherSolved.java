/* 2020/12/15 Nishikawa Hiroto */
/* Solved Dining Philosophers problem */
/* use Semaphore */
...
public class PhilosopherSolved extends ProcessSolved {
	int id = 0;
	int total = 0;
	Fork rFork, lFork;
	...
	public PhilosopherSolved(int id, MessageQueue mq,Semaphore waiter) {
		super(id, mq,waiter);
		this.id = id;
		this.waiter = waiter;
	}
